	...
	<div id="header">       
        <div id="menu">
            <ul>                                        
                ...
                <li><a href="services.html" title="">Sejarah</a></li>
                <li><a href="#" title="">Visi & Misi</a></li>
                <li><a href="#" title="">Profile</a></li>
                <li><a href="#" title="">Fasilitas</a></li>
                <li><a href="contact.html" title="">Hubungi Kami</a></li>
            </ul>
        </div>
...
ex ea commodo consequat.         
         ...
         <div id="left_nav">
            <ul>                                        
                <li><a href="index.php" title="">Lorem ipsum dolor sit amet</a></li>
...
ex ea commodo consequat.        
    ...
    <div style=" clear:both;"></div>
     ...
     <div id="footer">
     	<div class="copyright">
<a href="index.php"><img src="images/footer_logo.gif" alt="" title="" border="0"></a>
        </div>
